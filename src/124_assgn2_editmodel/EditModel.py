...
class EditModel(object):
  ...
  def insertEdits(self, word):
    ...
    for i in range(0, len(word)):
        ...
        for char in EditModel.ALPHABET:
          #The correct signal is character i followed by char
          correctLetters = corruptLetters + char
  ...
  def replaceEdits(self, word):
    ...
    for i in range(0, len(word)):
      ...
      corruptLetters = word[i] 
      for char in EditModel.ALPHABET:
        if(char != corruptLetters):
          #The correct signal is char
          correctLetters = char
